...
export default function EunsuArchive() {
  ...
  return <main>
    ...
    <footer><div className="footer-brand"><span className="brand-mark">은</span><b>우리 아들 특별한 이은수</b></div><p>은수의 오늘이 내일의 소중한 추억이 됩니다.</p><span>Made with <Heart size={15} fill="#ef7186"/> for Eunsu</span><a href="/admin" className="admin-link">사진 업로드 관리자</a><small>© 2026 Eunsu’s Family Archive</small></footer>
